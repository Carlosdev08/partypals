      ...
      <div className="bg-white">
        <div className="  flex flex-col justify-center items-center text-center mb-20 bg-  ">
          <div className="flex flex-col">
            <button className="text-7xl mt-40 pb-2 font-extrabold font-sans text-[#3d1645]">
          ...
          <TypingEffect
              ...
              className="font-outfit font-semibold text-lg text-[#3d1645] bg-blue-100  rounded bg-transparent"
            />
          </div>
        </div>
